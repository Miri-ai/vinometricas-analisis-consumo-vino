...
![Vista Global del dashboard Vinométricas](./images/dashboard_global.png)
...
Los datos de origen provienen de un dataset público de Kaggle. El proceso de trabajo, disponible en la carpeta [`/data`](./data), incluyó:

1. **[`Dataset_Vinos_2023_2024_500reg_QualitativeTrend.xlsx`](./data/Dataset_Vinos_2023_2024_500reg_QualitativeTrend.xlsx)** — matriz de datos base (extracción inicial, 500 registros)
2. **[`Ventas_Normalizada.xlsx`](./data/Ventas_Normalizada.xlsx)** — datos limpios y normalizados, listos para el modelado
